function ECOG_setup_laplacian_v2(chan_names,chan_names_orig,input_bad_chans)
...
save([pwd '/Laplacian_Map.mat'],'GridMaps','Virtual_El');

% Save the figures
savefig(h,[pwd '/Laplacian_Map.fig'])
