...
ht=text(.5,titleypos-1,str);set(ht,'horizontalalignment','center','fontsize',fs, 'FontName', 'Times','FontWeight','bold');
%set(gca, 'FontUnits', 'points', 'FontWeight','normal', 'FontSize', 18, 'FontName', 'Times')
...
% 3.27.2015, edited by Jacob to fix suptitle errors in 2014b
legH = legend;
try ~isempty(legH);
    axes(legH);
catch
