...
for chanx = plot_chans %[29 30 37 38 43:46 86:91]
    ...
    for j=1:NumConds
        ...
        for fi=1:num_frex
            ...
            tempITPC = abs(mean(exp(1i*angle1),2))';
...
for chanx = plot_chans %[29 30 37 38 43:46 86:91]
    ...
    for j=1:NumConds
        ...
        title(strcat('ERSP CH:   ', chan_names(chanx),      ' Cond: ',legend_array(j)),'FontWeight','bold');
        
        subplot(2,NumConds,j+NumConds)
        ...
        title(strcat('ITPC CH:   ', chan_names(chanx),      ' Cond: ',legend_array(j)),'FontWeight','bold');
    end
    pause()
end
