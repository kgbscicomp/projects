function [Induced_ButtOrd_Wide,Induced_ButtOrd_Narrow,Induced_evoked,Induced_FIRband_sig,Induced_Wide_morlet,Induced_Narrow_morlet] = ECOG_filter_analysis_old(subject,task,EEG,Conditions,CondNums,filter_range,filter_width,epoch,baseline,srate_downsample,input_bad_chans)
