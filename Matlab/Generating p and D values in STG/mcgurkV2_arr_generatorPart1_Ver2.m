...
clc
subjid = '1118UC';
load('UC1118_McGurk-bipolar.mat');
load('C:\Users\djbranglab-admin\Desktop\Karthik\Electrode_Registration\1118UC\Electrodes\Electrode_Labels.mat');

num_of_channels = length(OUTPUT.chan_names);
% analysis_window = 'aud-onset';%options: 'pre-stim', 'face-onset', 'face-move','aud-onset'
analysis_wind ow = 'pre-stim';
